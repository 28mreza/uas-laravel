            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control mb-3" name="username" value="{{ Auth::user()->username }}" >
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <input type="hidden" class="form-control mb-3" name="akses" value="{{ Auth::user()->akses }}" >
                    </div>
                    {{-- <div class="col-md-12">
