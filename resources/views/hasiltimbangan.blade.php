                    ...
                    <table class="table table-hover text-center" id="table1">
                        ...
                        @forelse ($gizi as $row)
                            <tr>
                                ...
                                <td class="align-middle">{{ $row->tinggibadan }} CM</td>
                                <td class="align-middle">{{ $row->beratbadan }} KG</td>
                                <td class="align-middle">{{ $row->status }}</td>
                                <td class="align-middle">
                                    {{-- <a href="/admin/jurusan/edit/{{ $row->idgizi}}" type="button" class="btn btn-info btn-sm"><i class="bi bi-pencil-square"></i></a> --}}
                                    {{-- <a href="/hasiltimbangan/delete/{{ $row->idgizi}}" type="button" class="btn btn-danger btn-sm" onclick="confirmation(event)"><i class="bi bi-trash"></i></a> --}}
                                </td>
                            </tr>
                        @empty
                            <tr>
